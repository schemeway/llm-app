...
config :llm_chat, LlmChatWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "HM8AfRs0nm4zc77+vdVwgLyfxQ/COrTzHAscLnm6DUIGsXJqoB1FQ0T92Gf5SGAd",
  watchers: [
...
# --------------------
# Configure your defaults for the LLM platforms here:
config :llm_chat,
  ...
  # or [Llm.Ollama] or [Llm.Bedrock]
  platforms: [Llm.Bedrock],
  # or Llm.Ollama
