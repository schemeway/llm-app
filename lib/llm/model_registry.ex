defmodule Llm.ModelRegistry do
  ...
  def init(:ok) do
    models = [
      %Model{name: "Qwen 3 (0.6b)", id: "qwen3:0.6b", rate: 15},
  ...
  def register_model(model_name, model_id, rate \\ 20) do
    GenServer.cast(__MODULE__, {:register_model, model_name, model_id, rate})
  end
